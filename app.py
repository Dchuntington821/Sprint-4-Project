...
if checked:
    ...
    fig6 = px.histogram(df, x = 'odometer', y = 'days_listed', nbins = 50, color = 'turnover_rate', width = 1000, height=550)
    fig6.update_layout(xaxis_title = 'Odometer Reading', yaxis_title='Days Listed', title = 'Odometer reading vs duration of days listed')
    ...
    fig6 = px.histogram(df, x = 'odometer', y = 'days_listed', nbins = 50, width = 1000, height=550)
    fig6.update_layout(xaxis_title = 'Odometer Reading', yaxis_title='Days Listed', title = 'Odometer reading vs duration of days listed')
...
st.write('How odometer reading effects a vehicles turnover rate')
