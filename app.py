...
df['odometer'] = df['odometer'].fillna(df['odometer'].mean().round(6))
...
if checked:
    ...
    fig5 = px.scatter(df, x='days_listed', y='condition', color='turnover_rate')

else:

    fig4 = fig4 = px.scatter(group2, x='days_listed', y='price')

    fig5 = fig5 = px.scatter(df, x = 'days_listed', y='condition')
